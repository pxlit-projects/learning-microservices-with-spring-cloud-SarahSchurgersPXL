    ...
    <div v-if="showAddProductForm">
      ...
      <form @submit.prevent="addProduct">
        ...
        <div>
          ...
          <input type="number" v-model.number="newProduct.price" id="price" required />
        </div>
        <div>
    ...
    <div v-if="showEditProductForm">
      ...
      <form @submit.prevent="updateProduct">
        ...
        <div>
          ...
          <input type="number" v-model.number="editProductData.price" id="editPrice" required />
        </div>
        <div>
...
export default {
  ...
  methods: {
    ...
    async updateProduct() {
      try {
        const response = await axios.put(`${process.env.VUE_APP_BACKEND_URL}/product/${this.editProductData.id}`, {
